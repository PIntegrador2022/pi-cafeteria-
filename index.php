   ...
   <div class="swiper principal-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            ...
            <div class="imagem">
               <img src="imagens/home-cafe-img.jpg" alt="">
            </div>
         </div>
         ...
         <div class="swiper-slide slide">
            <div class="conteudo">
               <span>Pedido On-line</span>
               <h3>Os  melhores cappuccinos</h3>
               <a href="menu.php" class="btn">Ver Menu</a>
            </div>
            <div class="imagem">
               <img src="imagens/home-cappuccino-img.jpg" alt="">
            </div>
         </div>
         ...
         <div class="swiper-slide slide">
            <div class="conteudo">
               <span>Pedido On-line</span>
               <h3>Os melhores pães</h3>
               <a href="menu.php" class="btn">Ver Menu</a>
            </div>
            <div class="imagem">
               <img src="imagens/home-pqueijo-img.jpg" alt="">
            </div>
         </div>
...
<section class="categoria">
   ...
   <div class="box-container">
      ...
      <a href="categoria.php?categoria=bolos" class="box">
         <img src="imagens/cat-3.png" alt="">
         <h3>Bólos</h3>
      </a>

      <a href="categoria.php?categoria=paes" class="box">
